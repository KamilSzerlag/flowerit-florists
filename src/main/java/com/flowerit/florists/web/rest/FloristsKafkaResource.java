...
@RestController
@RequestMapping("/api/florists-kafka")
public class FloristsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FloristsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public FloristsKafkaResource(KafkaProperties kafkaProperties) {
